...
Func Example()
	...
	Local $hBitmap = _GDIPlus_ImageLoadFromFile("C:\Developpement\Github\Universal-XML-Scraper\Images\GG.jpg") ;create a GDI bitmap by capturing 1/4 of desktop
...
;~ 	_WinAPI_DeleteObject($hHBmp) ;release GDI bitmap resource because not needed anymore
	...
	ConsoleWrite(_GDIPlus_ImageGetWidth($hBitmap) &"x"& _GDIPlus_ImageGetHeight($hBitmap))
